...
@section('container')
    <h1 class="mb-5">{{ $title }}</h1>
     ...
     @if ($posts->count())
        <div class="card mb-3">
        <img src="https://source.unsplash.com/1100x400?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="position-absolut px3 py2 text-white" style="background-color: rgba(0, 0, 0, 0.7)"><a href="/categories/{{ $post->category->slug}}"class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
